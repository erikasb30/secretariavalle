...
//        echo '<b>Read Cell Annotation</b><br />';
  ...
  // Verificar la versión y procesar según corresponda
  if ($this->version == self::XLS_BIFF8) {
      ...
      // Verificar si $noteObjID está definido y luego asignar a $this->cellNotes
      if (isset($noteObjID)) {
          ...
          // Caso especial cuando $noteObjID no está definido
          $extension = false;
